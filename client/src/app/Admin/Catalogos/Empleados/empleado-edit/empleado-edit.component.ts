...
export class EmpleadoEditComponent implements OnInit {
  ...
  @Input() empleado: EmpleadoEditReq;
  @Output() cerrar = new EventEmitter();

  @ViewChild('dialogEmpleadoIdInput') oDialogEmpleadoioIdInput: ElementRef;
  ...
  resetStatusDialog(){
    this._renderer.setAttribute(this.oDialogUsuarioIdInput.nativeElement, 'value-state', '');
    this._renderer.setAttribute(this.oDialogPuestoIdInput.nativeElement, 'value-state', '');    
  }
  ...
  guardar(){
    ...
    this.empleado.validoHastaStr = this.oDialogValidoHastaInput.nativeElement.value
    this.empleado.borrado = this.oDialogBorradoInput.nativeElement.checked
    ...
    if(!error){
      console.log(this.empleado);
       this.empleadoService.empleadoEdit(this.empleado).subscribe(response =>{
        //console.log(result);
        var lvError = false
